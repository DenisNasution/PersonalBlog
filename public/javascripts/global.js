...
(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = "function" == typeof require && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = "MODULE_NOT_FOUND", a } var p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = "function" == typeof require && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
    1: [function (require, module, exports) {
        ...
        const data = JSON.parse(localStorage.getItem('persona_data'))
        // if (document.cookie) {
        //     profile.innerHTML = `<h1> ${data.username} </h1>`
        // }
        burger.addEventListener('click', async (e) => {
            ...
            listMenu.classList.add('flex')
            fullnavbar.classList.add("grid", "content-center", "absolute", "top-0", "bottom-0", "left-0", "right-0", "bg-navbar", "py-auto", "h-screen")
        ...
        cross.addEventListener('click', async (e) => {
            ...
            // console.log('test');
            cross.classList.toggle('hidden')
            fullnavbar.className = ""
            listMenu.classList.remove('flex')
            listMenu.classList.toggle('hidden')
        })

        logout.addEventListener('click', async (e) => {
            e.preventDefault()
            // document.cookie = "auth_sign=;max-age=0"
            console.log('test');
            await Axios.get('http://localhost:2500/signout')
                .then(response => {
