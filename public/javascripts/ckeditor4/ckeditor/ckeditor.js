...
(function () {
    if (window.CKEDITOR && window.CKEDITOR.dom) return; window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
            timestamp: "M4I8", version: "4.19.0", revision: "c08cfedb60", rnd: Math.floor(900 * Math.random()) + 100, _: { pending: [], basePathSrcPattern: a }, status: "unloaded", basePath: function () {
    ...
    (function () {
        var a = {}; CKEDITOR.event || (CKEDITOR.event = function () { }, CKEDITOR.event.implementOn = function (a) { var b = CKEDITOR.event.prototype, c; for (c in b) null == a[c] && (a[c] = b[c]) }, CKEDITOR.event.prototype = function () {
            function d(a) { var e = b(this); return e[a] || (e[a] = new c(a)) } var b = function (a) { a = a.getPrivate && a.getPrivate() || a._ || (a._ = {}); return a.events || (a.events = {}) }, c = function (a) { this.name = a; this.listeners = [] }; c.prototype = {
                ...
                define: function (a, b) { var c = d.call(this, a); CKEDITOR.tools.extend(c, b, !0) }, on: function (b, c, k, h, q) {
                    function m(x, y, l, A) { x = { name: b, sender: this, editor: x, data: y, listenerData: h, stop: l, cancel: A, removeListener: g }; return !1 === c.call(k, x) ? a : x.data } function g() { x.removeListener(b, c) } var x = this, y = d.call(this, b); if (0 > y.getListenerIndex(c)) {
                        y = y.listeners; k || (k = this); isNaN(q) && (q = 10); m.fn = c; m.priority = q; for (var A = y.length - 1; 0 <= A; A--)if (y[A].priority <= q) return y.splice(A + 1, 0, m), { removeListener: g };
                        y.unshift(m)
                    } return { removeListener: g }
                }, once: function () { var a = Array.prototype.slice.call(arguments), b = a[1]; a[1] = function (a) { a.removeListener(); return b.apply(this, arguments) }; return this.on.apply(this, a) }, capture: function () { CKEDITOR.event.useCapture = 1; var a = this.on.apply(this, arguments); CKEDITOR.event.useCapture = 0; return a }, fire: function () {
                    var c = 0, e = function () { c = 1 }, d = 0, h = function () { d = 1 }; return function (q, m, g) {
                        var x = b(this)[q]; q = c; var y = d; c = d = 0; if (x) {
                        ...
                        } m = d ? !1 : "undefined" == typeof m ? !0 : m; c = q; d = y; return m
                    }
    ...
    (function () {
        function a(a, y, b) { this._minInterval = a; this._context = b; this._lastOutput = this._scheduledTimer = 0; this._output = CKEDITOR.tools.bind(y, b || {}); var c = this; this.input = function () { function a() { c._lastOutput = (new Date).getTime(); c._scheduledTimer = 0; c._call() } if (!c._scheduledTimer || !1 !== c._reschedule()) { var x = (new Date).getTime() - c._lastOutput; x < c._minInterval ? c._scheduledTimer = setTimeout(a, c._minInterval - x) : a() } } } function d(x, y, b) {
        ...
        } var b = [], c = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", f = /&/g, e = />/g, k = /</g, h = /"/g, q = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, m = { lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­" }, g = function (a, y) { return "#" == y[0] ? String.fromCharCode(parseInt(y.slice(1), 10)) : m[y] }; CKEDITOR.on("reset", function () { b = [] }); CKEDITOR.tools = {
            arrayCompare: function (a, y) {
                ...
                return void 0 === a || null === a ? "" : String(a).replace(f, "\x26amp;").replace(e, "\x26gt;").replace(k,
                    "\x26lt;")
            }, htmlDecode: function (a) { return a.replace(q, g) }, htmlEncodeAttr: function (a) { return CKEDITOR.tools.htmlEncode(a).replace(h, "\x26quot;") }, htmlDecodeAttr: function (a) { return CKEDITOR.tools.htmlDecode(a) }, transformPlainTextToHtml: function (a, b) {
                ...
                a = a.statics; !b && (b = function () { c && this.base.apply(this, arguments) }); if (g) var l = b, b = function () { var a = this._ || (this._ = {}), b; for (b in g) { var c = g[b]; a[b] = "function" == typeof c ? CKEDITOR.tools.bind(c, this) : c } l.apply(this, arguments) }; c && (b.prototype = this.prototypedCopy(c.prototype), b.prototype.constructor = b, b.base = c, b.baseProto = c.prototype, b.prototype.base = function w() { this.base = c.prototype.base; c.apply(this, arguments); this.base = w }); h && this.extend(b.prototype, h, !0); a && this.extend(b, a, !0); return b
                ...
                c) { return b.push(function () { return a.apply(c || this, arguments) }) - 1 }, removeFunction: function (a) { b[a] = null }, callFunction: function (a) { var c = b[a]; return c && c.apply(window, Array.prototype.slice.call(arguments, 1)) }, cssLength: function () { var a = /^-?\d+\.?\d*px$/, b; return function (c) { b = CKEDITOR.tools.trim(c + "") + "px"; return a.test(b) ? b : c || "" } }(), convertToPx: function () {
                    ...
                    var g = {}; c && (a = (new CKEDITOR.dom.element("span")).setAttribute("style", a).getAttribute("style") || ""); a && (a = CKEDITOR.tools.normalizeHex(CKEDITOR.tools.convertRgbToHex(a))); if (!a || ";" == a) return g; a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g,
                        function (a, c, x) { b && (c = c.toLowerCase(), "font-family" == c && (x = x.replace(/\s*,\s*/g, ",")), x = CKEDITOR.tools.trim(x)); g[c] = x }); return g
                    ...
                    b) { var c = this.keystrokeToArray(a, b); c.display = c.display.join("+"); c.aria = c.aria.join("+"); return c }, keystrokeToArray: function (a, b) { var c = b & 16711680, g = b & 65535, h = CKEDITOR.env.mac, l = [], e = []; c & CKEDITOR.CTRL && (l.push(h ? "⌘" : a[17]), e.push(h ? a[224] : a[17])); c & CKEDITOR.ALT && (l.push(h ? "⌥" : a[18]), e.push(a[18])); c & CKEDITOR.SHIFT && (l.push(h ? "⇧" : a[16]), e.push(a[16])); g && (a[g] ? (l.push(a[g]), e.push(a[g])) : (l.push(String.fromCharCode(g)), e.push(String.fromCharCode(g)))); return { display: l, aria: e } }, transparentImageData: "data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw\x3d\x3d",
            getCookie: function (a) { a = a.toLowerCase(); for (var b = document.cookie.split(";"), c, g, h = 0; h < b.length; h++)if (c = b[h].split("\x3d"), g = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase()), g === a) return decodeURIComponent(1 < c.length ? c[1] : ""); return null }, setCookie: function (a, b) { document.cookie = encodeURIComponent(a) + "\x3d" + encodeURIComponent(b) + ";path\x3d/" }, getCsrfToken: function () {
                ...
                if (a) if (window.CSS && CSS.escape) a = CSS.escape(a); else {
                    a = String(a); for (var b = a.length, c = -1, g, h = "", l = a.charCodeAt(0); ++c < b;)g = a.charCodeAt(c), h = 0 == g ? h + "�" : 127 == g || 1 <= g && 31 >= g || 0 == c && 48 <=
                        g && 57 >= g || 1 == c && 48 <= g && 57 >= g && 45 == l ? h + ("\\" + g.toString(16) + " ") : 0 == c && 1 == b && 45 == g ? h + ("\\" + a.charAt(c)) : 128 <= g || 45 == g || 95 == g || 48 <= g && 57 >= g || 65 <= g && 90 >= g || 97 <= g && 122 >= g ? h + a.charAt(c) : h + ("\\" + a.charAt(c)); a = h
                } else a = ""; return a
                ...
                var b = "", c = a.length, g; for (g = 0; g < c; g += 3) {
                    var h = a.slice(g, g + 3), l = h.length, e = [], d; if (3 > l) for (d = l; 3 > d; d++)h[d] = 0; e[0] = (h[0] & 252) >> 2; e[1] = (h[0] & 3) << 4 | h[1] >> 4; e[2] = (h[1] & 15) << 2 | (h[2] & 192) >> 6; e[3] = h[2] & 63; for (d = 0; 4 > d; d++)b = d <= l ?
                ...
                filter: function (a, b, c) {
                    var g = []; this.forEach(a,
                        function (h, l) { b.call(c, h, l, a) && g.push(h) }); return g
    ...
    CKEDITOR.dtd = function () {
        ...
        a(b, { a: 1, abbr: 1, area: 1, audio: 1, b: 1, bdi: 1, bdo: 1, br: 1, button: 1, canvas: 1, cite: 1, code: 1, command: 1, datalist: 1, del: 1, dfn: 1, em: 1, embed: 1, i: 1, iframe: 1, img: 1, input: 1, ins: 1, kbd: 1, keygen: 1, label: 1, map: 1, mark: 1, meter: 1, noscript: 1, object: 1, output: 1, progress: 1, q: 1, ruby: 1, s: 1, samp: 1, script: 1, select: 1, small: 1, span: 1, strong: 1, sub: 1, sup: 1, textarea: 1, time: 1, u: 1, "var": 1, video: 1, wbr: 1 }, h, { acronym: 1, applet: 1, basefont: 1, big: 1, font: 1, isindex: 1, strike: 1, style: 1, tt: 1 }); a(c, f, b, q); d = {
            ...
            $block: a({ audio: 1, dd: 1, dt: 1, figcaption: 1, li: 1, video: 1 }, f, q), $blockLimit: {
        ...
        function a(a, b) { return -1 < (" " + a + " ").replace(e, " ").indexOf(" " + b + " ") } function d(a) { var b = !0; a.$.id || (a.$.id = "cke_tmp_" + CKEDITOR.tools.getNextNumber(), b = !1); return function () { b || a.removeAttribute("id") } } function b(a, b) { var c = CKEDITOR.tools.escapeCss(a.$.id); return "#" + c + " " + b.split(/,\s*/).join(", #" + c + " ") } function c(a) { for (var b = 0, c = 0, g = k[a].length; c < g; c++)b += parseFloat(this.getComputedStyle(k[a][c]) || 0, 10) || 0; return b } var f = document.createElement("_").classList, f = "undefined" !== typeof f &&
            null !== String(f.add).match(/\[Native code\]/gi), e = /[\n\t\r]/g; CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
                ...
                is: function () { var a = this.getName(); if ("object" == typeof arguments[0]) return !!arguments[0][a]; for (var b = 0; b < arguments.length; b++)if (arguments[b] == a) return !0; return !1 }, isEditable: function (a) {
                    ...
                    CKEDITOR.env.webkit && (e = this.getEditor(!1)) && (e._.previousScrollTop = null); e = a.getWindow(); d = v(this, e); var w = v(a, e), J = this.$.offsetHeight; g = this.$.offsetWidth; var G = a.$.clientHeight, p = a.$.clientWidth; e = d.x - l(this, "left") - w.x || 0; f = d.y - l(this, "top") - w.y || 0; g = d.x + g + l(this, "right") - (w.x + p) || 0; d = d.y + J + l(this, "bottom") - (w.y + G) || 0; (0 > f || 0 < d) && k(0, !0 === b ? f : !1 === b ? d : 0 > f ? f : d); c && (0 > e || 0 < g) && k(0 > e ? e : g, 0)
    ...
    (function () {
        function a(a, b) {
            var c = this.range; if (this._.end) return null; if (!this._.start) { this._.start = 1; if (c.collapsed) return this.end(), null; c.optimize() } var g, d = c.startContainer; g = c.endContainer; var e = c.startOffset, f = c.endOffset, x, h = this.guard, k = this.type, m = a ? "getPreviousSourceNode" : "getNextSourceNode"; if (!a && !this._.guardLTR) {
                var q = g.type == CKEDITOR.NODE_ELEMENT ? g : g.getParent(), E = g.type == CKEDITOR.NODE_ELEMENT ? g.getChild(f) : g.getNext(); this._.guardLTR = function (a, b) {
        ...
        CKEDITOR.dom.walker.bookmark = function (a, b) { function c(a) { return a && a.getName && "span" == a.getName() && a.data("cke-bookmark") } return function (g) { var d, e; d = g && g.type != CKEDITOR.NODE_ELEMENT && (e = g.getParent()) && c(e); d = a ? d : d || c(g); return !!(b ^ d) } }; CKEDITOR.dom.walker.whitespaces = function (a) { return function (b) { var c; b && b.type == CKEDITOR.NODE_TEXT && (c = !CKEDITOR.tools.trim(b.getText()) || CKEDITOR.env.webkit && b.getText() == CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE); return !!(a ^ c) } }; CKEDITOR.dom.walker.invisible =
            function (a) { var b = CKEDITOR.dom.walker.whitespaces(), c = CKEDITOR.env.webkit ? 1 : 0; return function (g) { b(g) ? g = 1 : (g.type == CKEDITOR.NODE_TEXT && (g = g.getParent()), g = g.$.offsetWidth <= c); return !!(a ^ g) } }; CKEDITOR.dom.walker.nodeType = function (a, b) { return function (c) { return !!(b ^ c.type == a) } }; CKEDITOR.dom.walker.bogus = function (a) {
            ...
            }; CKEDITOR.dom.walker.temp = function (a) { return function (b) { b.type != CKEDITOR.NODE_ELEMENT && (b = b.getParent()); b = b && b.hasAttribute("data-cke-temp"); return !!(a ^ b) } }; var f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, e = CKEDITOR.dom.walker.whitespaces(), k = CKEDITOR.dom.walker.bookmark(), h = CKEDITOR.dom.walker.temp(), q = function (a) { return k(a) || e(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty) }; CKEDITOR.dom.walker.ignored =
                ...
                }; CKEDITOR.dom.element.prototype.getBogus = function () { var a = this; do a = a.getPreviousSourceNode(); while (q(a)); return a && (CKEDITOR.env.needsBrFiller ? a.is && a.is("br") : a.getText && f.test(a.getText())) ? a : !1 }
    })(); "use strict";
    ...
    (function () {
        function a(a) { a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset } function d(a, b, c, d, e) {
            function f(a, b, c, g) { var R = c ? a.getPrevious() : a.getNext(); if (g && k) return R; q || g ? b.append(a.clone(!0, e), c) : (a.remove(), m && b.append(a, c)); return R } function l() { var a, b, c, g = Math.min(N.length, r.length); for (a = 0; a < g; a++)if (b = N[a], c = r[a], !b.equals(c)) return a; return a - 1 } function h() {
                var b = I - 1, c = B && z && !p.equals(u); b < M - 1 || b < n - 1 || c ? (c ? a.moveToPosition(u,
                    CKEDITOR.POSITION_BEFORE_START) : n == b + 1 && t ? a.moveToPosition(r[b], CKEDITOR.POSITION_BEFORE_END) : a.moveToPosition(r[b + 1], CKEDITOR.POSITION_BEFORE_START), d && (b = N[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT && (c = CKEDITOR.dom.element.createFromHtml('\x3cspan data-cke-bookmark\x3d"1" style\x3d"display:none"\x3e\x26nbsp;\x3c/span\x3e', a.document), c.insertAfter(b), b.mergeSiblings(!1), a.moveToBookmark({ startNode: c }))) : a.collapse(!0)
            } a.optimizeBookmark(); var k = 0 === b, m = 1 == b, q = 2 == b; b = q || m; var p = a.startContainer, u = a.endContainer,
                K = a.startOffset, E = a.endOffset, C, t, B, z, H, O; if (q && u.type == CKEDITOR.NODE_TEXT && (p.equals(u) || p.type === CKEDITOR.NODE_ELEMENT && p.getFirst().equals(u))) c.append(a.document.createText(u.substring(K, E))); else {
                    u.type == CKEDITOR.NODE_TEXT ? q ? O = !0 : u = u.split(E) : 0 < u.getChildCount() ? E >= u.getChildCount() ? (u = u.getChild(E - 1), t = !0) : u = u.getChild(E) : z = t = !0; p.type == CKEDITOR.NODE_TEXT ? q ? H = !0 : p.split(K) : 0 < p.getChildCount() ? 0 === K ? (p = p.getChild(K), C = !0) : p = p.getChild(K - 1) : B = C = !0; for (var N = p.getParents(), r = u.getParents(), I = l(),
                        M = N.length - 1, n = r.length - 1, D = c, R, aa, X, ea = -1, V = I; V <= M; V++) { aa = N[V]; X = aa.getNext(); for (V != M || aa.equals(r[V]) && M < n ? b && (R = D.append(aa.clone(0, e))) : C ? f(aa, D, !1, B) : H && D.append(a.document.createText(aa.substring(K))); X;) { if (X.equals(r[V])) { ea = V; break } X = f(X, D) } D = R } D = c; for (V = I; V <= n; V++)if (c = r[V], X = c.getPrevious(), c.equals(N[V])) b && (D = D.getChild(0)); else { V != n || c.equals(N[V]) && n < M ? b && (R = D.append(c.clone(0, e))) : t ? f(c, D, !1, z) : O && D.append(a.document.createText(c.substring(0, E))); if (V > ea) for (; X;)X = f(X, D, !0); D = R } q ||
                            h()
                }
        ...
        function f(a) { return function () { var b; return this[a ? "getPreviousNode" : "getNextNode"](function (a) { !b && m(a) && (b = a); return q(a) && !(k(a) && a.equals(b)) }) } } var e = { abbr: 1, acronym: 1, b: 1, bdo: 1, big: 1, cite: 1, code: 1, del: 1, dfn: 1, em: 1, font: 1, i: 1, ins: 1, label: 1, kbd: 1, q: 1, samp: 1, small: 1, span: 1, strike: 1, strong: 1, sub: 1, sup: 1, tt: 1, u: 1, "var": 1 }, k = CKEDITOR.dom.walker.bogus(), h = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, q = CKEDITOR.dom.walker.editable(), m = CKEDITOR.dom.walker.ignored(!0); CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                function c(a) { return a && a.type == CKEDITOR.NODE_ELEMENT && a.hasAttribute("contenteditable") ? null : a } function d(a, b, c) {
                    ...
                    case CKEDITOR.ENLARGE_INLINE: var h = 1; case CKEDITOR.ENLARGE_ELEMENT: if (this.collapsed) break; var k = this.getCommonAncestor(); l = this.root; var m, q, p, u, K, E = !1, C; C = this.startContainer; var t = this.startOffset; C.type == CKEDITOR.NODE_TEXT ? (t && (C = !CKEDITOR.tools.trim(C.substring(0, t)).length && C, E = !!C), C && ((u = C.getPrevious()) || (p = C.getParent()))) : (t && (u = C.getChild(t - 1) || C.getLast()), u || (p = C)); for (p = c(p); p ||
                        u;) {
                        if (p && !u) { !K && p.equals(k) && (K = !0); if (h ? p.isBlockBoundary() : !l.contains(p)) break; E && "inline" == p.getComputedStyle("display") || (E = !1, K ? m = p : this.setStartBefore(p)); u = p.getPrevious() } for (; u;)if (C = !1, u.type == CKEDITOR.NODE_COMMENT) u = u.getPrevious(); else {
                            ...
                            } else u = null; C && (E ? K ? m = p : p && this.setStartBefore(p) : E = !0); if (u) { C = u.getPrevious(); if (!p && !C) { p = u; u = null; break } u = C } else p = null
                        } p && (p = c(p.getParent()))
                    } C = this.endContainer; t = this.endOffset; p = u = null; K = E = !1; C.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(C.substring(t)).length ? E = !0 : (E = !C.getLength(), t == C.getLength() ? (u = C.getNext()) || (p = C.getParent()) : d(C,
                        t, l) && (p = C.getParent())) : (u = C.getChild(t)) || (p = C); for (; p || u;) {
                            if (p && !u) { !K && p.equals(k) && (K = !0); if (h ? p.isBlockBoundary() : !l.contains(p)) break; E && "inline" == p.getComputedStyle("display") || (E = !1, K ? q = p : p && this.setEndAfter(p)); u = p.getNext() } for (; u;) {
                                ...
                                } else C = 1; C && E && (K ? q = p : this.setEndAfter(p)); if (u) { C = u.getNext(); if (!p && !C) { p = u; u = null; break } u = C } else p = null
                            } p && (p = c(p.getParent()))
                        } m && q && (k = m.contains(q) ? q : m, this.setStartBefore(k), this.setEndAfter(k)); break; case CKEDITOR.ENLARGE_BLOCK_CONTENTS: case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS: p = new CKEDITOR.dom.range(this.root); l = this.root; p.setStartAt(l,
                            CKEDITOR.POSITION_AFTER_START); p.setEnd(this.startContainer, this.startOffset); p = new CKEDITOR.dom.walker(p); var H, O, N = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null), r = null, I = function (a) { if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable")) if (r) { if (r.equals(a)) { r = null; return } } else r = a; else if (r) return; var b = N(a); b || (H = a); return b }, h = function (a) { var b = I(a); !b && a.is && a.is("br") && (O = a); return b }; p.guard = I; p = p.lastBackward(); H = H || l; this.setStartAt(H,
                                !H.is("br") && (!p && this.checkStartOfBlock() || p && H.contains(p)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END); if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { p = this.clone(); p = new CKEDITOR.dom.walker(p); var M = CKEDITOR.dom.walker.whitespaces(), n = CKEDITOR.dom.walker.bookmark(); p.evaluator = function (a) { return !M(a) && !n(a) }; if ((p = p.previous()) && p.type == CKEDITOR.NODE_ELEMENT && p.is("br")) break } p = this.clone(); p.collapse(); p.setEndAt(l, CKEDITOR.POSITION_BEFORE_END); p = new CKEDITOR.dom.walker(p); p.guard =
                                    a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? h : I; H = r = O = null; p = p.lastForward(); H = H || l; this.setEndAt(H, !p && this.checkEndOfBlock() || p && H.contains(p) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START); O && this.setEndAfter(O)
                }
                ...
                var d = "boolean" === typeof c ? c : c && "boolean" === typeof c.shrinkOnBlockBoundary ? c.shrinkOnBlockBoundary : !0, e = c && c.skipBogus; if (!this.collapsed) {
                    a = a || CKEDITOR.SHRINK_TEXT; var f = this.clone(), l = this.startContainer, h = this.endContainer, k = this.startOffset, m = this.endOffset,
                        ...
                        }; c && (l = f[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) && this.setStartAt(l, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START); q && (f.reset(), (f = f[a == CKEDITOR.SHRINK_ELEMENT ? "lastBackward" : "previous"]()) && this.setEndAt(f, b ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_AFTER_END));
                    return !(!c && !q)
                }
    ...
    (function () {
        function a(a) { 1 > arguments.length || (this.range = a, this.forceBrBreak = 0, this.enlargeBr = 1, this.enforceRealBlocks = 0, this._ || (this._ = {})) } function d(a) { var b = []; a.forEach(function (a) { if ("true" == a.getAttribute("contenteditable")) return b.push(a), !1 }, CKEDITOR.NODE_ELEMENT, !0); return b } function b(a, c, e, f) {
            ...
            h = function (a) { return e(a) && k(a) }, q = { dd: 1, dt: 1, li: 1 }; a.prototype = {
                getNextParagraph: function (a) {
                    var d, k, y, A, F; a = a || "p"; if (this._.nestedEditable) {
                        ...
                        var L = 0, w = l.hasAscendant("pre"), J = l.type != CKEDITOR.NODE_ELEMENT, G = 0; if (J) l.type == CKEDITOR.NODE_TEXT && f.test(l.getText()) && (J = 0); else {
                            var p = l.getName();
                            if (CKEDITOR.dtd.$block[p] && "false" == l.getAttribute("contenteditable")) { d = l; b(this, a, d); break } else if (l.isBlockBoundary(this.forceBrBreak && !w && { br: 1 })) { if ("br" == p) J = 1; else if (!k && !l.getChildCount() && "hr" != p) { d = l; y = l.equals(v); break } k && (k.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), "br" != p && (this._.nextNode = l)); L = 1 } else { if (l.getFirst()) { k || (k = this.range.clone(), k.setStartAt(l, CKEDITOR.POSITION_BEFORE_START)); l = l.getFirst(); continue } J = 1 }
                        } J && !k && (k = this.range.clone(), k.setStartAt(l, CKEDITOR.POSITION_BEFORE_START));
                        y = (!L || J) && l.equals(v); if (k && !L) for (; !l.getNext(h) && !y;) { p = l.getParent(); if (p.isBlockBoundary(this.forceBrBreak && !w && { br: 1 })) { L = 1; J = 0; y || p.equals(v); k.setEndAt(p, CKEDITOR.POSITION_BEFORE_END); break } l = p; J = 1; y = l.equals(v); G = 1 } J && k.setEndAt(l, CKEDITOR.POSITION_AFTER_END); l = this._getNextSourceNode(l, G, v); if ((y = !l) || L && k) break
                    } if (!d) {
    ...
    (function () {
        function a(a, b, c, d, e) {
            var f, g; a = []; for (f in b) {
                g = b[f]; g = "boolean" == typeof g ? {} : "function" == typeof g ? { match: g } : B(g); "$" != f.charAt(0) && (g.elements = f); c && (g.featureName = c.toLowerCase()); var n = g; n.elements = k(n.elements, /\s+/) || null; n.propertiesOnly = n.propertiesOnly || !0 === n.elements; var t = /\s*,\s*/, r = void 0; for (r in O) {
                    n[r] = k(n[r], t) || null; var l = n, z = N[r], h = k(n[N[r]], t), E = n[r], D = [], H = !0, I = void 0; h ? H = !1 : h = {}; for (I in E) "!" == I.charAt(0) && (I = I.slice(1), D.push(I), h[I] = !0, H = !1); for (; I = D.pop();)E[I] =
                ...
                f = B(a[c]); g = !0 === f.classes || !0 === f.styles || !0 === f.attributes; n = f; r = z = t = void 0; for (t in O) n[t] = L(n[t]); l = !0; for (r in N) { t = N[r]; z = n[t]; h = []; E = void 0; for (E in z) -1 < E.indexOf("*") ? h.push(new RegExp("^" + E.replace(/\*/g, ".*") + "$")) : h.push(E); z = h; z.length && (n[t] = z, l = !1) } n.nothingRequired = l; n.noProperties = !(n.attributes || n.classes || n.styles); if (!0 === f.elements ||
            ...
            b) { if (!a) return !1; var c = !1, d = !0 === a, e; for (e in b) if (d || a(e)) delete b[e], c = !0; return c } function e(a, b, c) { if (a.disabled || a.customConfig && !c || !b) return !1; a._.cachedChecks = {}; return !0 } function k(a, b) { if (!a) return !1; if (!0 === a) return a; if ("string" == typeof a) return a = z(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b)); if (CKEDITOR.tools.isArray(a)) return a.length ? CKEDITOR.tools.convertArrayToObject(a) : !1; var c = {}, d = 0, e; for (e in a) c[e] = a[e], d++; return d ? c : !1 } function h(a, b) {
                ...
                var c, d, e, f; if (e = a.requiredClasses) for (f = b.classes, c = 0; c < e.length; ++c)if (d = e[c], "string" == typeof d) { if (-1 == CKEDITOR.tools.indexOf(f, d)) return !1 } else if (!CKEDITOR.tools.checkIfAnyArrayItemMatches(f, d)) return !1; return q(b.styles, a.requiredStyles) && q(b.attributes, a.requiredAttributes)
            } function q(a, b) { if (!b) return !0; for (var c = 0, d; c < b.length; ++c)if (d = b[c], "string" == typeof d) { if (!(d in a)) return !1 } else if (!CKEDITOR.tools.checkIfAnyObjectPropertyMatches(a, d)) return !1; return !0 } function m(a) {
                if (!a) return {};
                ...
                var g = 0, t; f.toHtml && (b.name = b.name.replace(M, "$1")); if (f.doCallbacks && a.elementCallbacks) { a: { t = a.elementCallbacks; for (var r = 0, z = t.length, B; r < z; ++r)if (B = t[r](b)) { t = B; break a } t = void 0 } if (t) return t } if (f.doTransform && (t = a._.transformations[b.name])) { y(b); for (r = 0; r < t.length; ++r)p(a, b, t[r]); v(b) } if (f.doFilter) {
                    a: {
                    ...
                    t = a.validClasses; var r = b.attributes, H = b.styles, z = b.classes; B = b.classBackup; var N = b.styleBackup, I, C, O = [], k = [], m = /^data-cke-/; h = !1; delete r.style; delete r["class"]; delete b.classBackup; delete b.styleBackup; if (!a.allAttributes) for (I in r) E[I] || (m.test(I) ? I == (C = I.replace(/^data-cke-saved-/, "")) || E[C] || (delete r[I], h = !0) : (delete r[I], h = !0)); if (!a.allStyles || a.hadInvalidStyle) { for (I in H) a.allStyles || D[I] ? O.push(I + ":" + H[I]) : h = !0; O.length && (r.style = O.sort().join("; ")) } else N && (r.style = N); if (!a.allClasses ||
            ...
            } function p(a, b, c) { var d, e; for (d = 0; d < c.length; ++d)if (e = c[d], !(e.check && !a.check(e.check, !1) || e.left && !e.left(b))) { e.right(b, D); break } } function u(a, b) {
                ...
                addContentForms: function (a) { if (!this.disabled && a) { var b, c, d = [], e; for (b = 0; b < a.length && !e; ++b)c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (e = c); if (e) { for (b = 0; b < a.length; ++b)d.push(K(a[b], e)); this.addTransformations(d) } } }, addElementCallback: function (a) { this.elementCallbacks || (this.elementCallbacks = []); this.elementCallbacks.push(a) }, addFeature: function (a) {
                    ...
                    if (this.disabled) return !0; if (CKEDITOR.tools.isArray(a)) { for (var d = a.length; d--;)if (this.check(a[d], b, c)) return !0; return !1 } var e, f; if ("string" == typeof a) {
                        ...
                        for (d =
                            0; d < r.length; ++d)p(this, e, r[d]); v(e)
            ...
            }; var O = { styles: 1, attributes: 1, classes: 1 }, N = { styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses" }, r = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, I = { styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/ }, M = /^cke:(object|embed|param)$/, n = /^(object|embed|param)$/, D; D = CKEDITOR.filter.transformationsTools = {
                sizeToStyle: function (a) {
                    ...
                    if ("string" == typeof b) a.name = b; else {
                        var c = b.getDefinition(), d = c.styles, e = c.attributes, f, n, g, t; a.name = c.element; for (f in e) if ("class" ==
                            f) for (c = a.classes.join("|"), g = e[f].split(/\s+/); t = g.pop();)-1 == c.indexOf(t) && a.classes.push(t); else a.attributes[f] = e[f]; for (n in d) a.styles[n] = d[n]
                    }
                }
            }
    })();
    ...
    CKEDITOR.scriptLoader = function () {
        var a = {}, d = {}; return {
            load: function (b, c, f, e) {
                var k = "string" == typeof b; k && (b = [b]); f || (f = CKEDITOR); var h = b.length, q = h, m = [], g = [], x = function (a) { c && (k ? c.call(f, a) : c.call(f, m, g)) }; if (0 === q) x(!0); else {
                    var y = function (a, b) { (b ? m : g).push(a); 0 >= --q && (e && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), x(b)) }, A = function (b, c) { a[b] = 1; var e = d[b]; delete d[b]; for (var f = 0; f < e.length; f++)e[f](b, c) }, F = function (b) {
                        if (a[b]) y(b, !0); else {
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (a, d) { if (this.registered[a]) throw Error('[CKEDITOR.resourceManager.add] The resource name "' + a + '" is already registered.'); var b = this.registered[a] = d || {}; b.name = a; b.path = this.getPath(a); CKEDITOR.fire(a + CKEDITOR.tools.capitalize(this.fileName) + "Ready", b); return this.get(a) }, get: function (a) { return this.registered[a] || null }, getPath: function (a) { var d = this.externals[a]; return CKEDITOR.getUrl(d && d.dir || this.basePath + a + "/") }, getFilePath: function (a) {
            ...
            CKEDITOR.tools.isArray(a) || (a = a ? [a] : []); for (var c = this.loaded, f = this.registered, e = [], k = {}, h = {}, q = 0; q < a.length; q++) { var m = a[q]; if (m) if (c[m] || f[m]) h[m] = this.get(m); else { var g = this.getFilePath(m); e.push(g); g in k || (k[g] = []); k[g].push(m) } } CKEDITOR.scriptLoader.load(e,
            ...
            function b(a) { if (!a) return ""; CKEDITOR.tools.isArray(a) && (a = a.join(",")); return a.replace(/\s/g, "") } var c = a.config, d = b(c.plugins), e = b(c.extraPlugins), f = b(c.removePlugins); if (e) var g = new RegExp("(?:^|,)(?:" + e.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), d = d.replace(g, ""), d = d + ("," + e); if (f) var h = new RegExp("(?:^|,)(?:" +
                f.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), d = d.replace(h, ""); CKEDITOR.env.air && (d += ",adobeair"); CKEDITOR.plugins.load(d.split(","), function (b) {
                    var d = [], e = [], f = []; a.plugins = CKEDITOR.tools.extend({}, a.plugins, b); for (var g in b) {
                        var k = b[g], O = k.lang, N = null, r = k.requires, I; CKEDITOR.tools.isArray(r) && (r = r.join(",")); if (r && (I = r.match(h))) for (; r = I.pop();)CKEDITOR.error("editor-plugin-required", { plugin: r.replace(",", ""), requiredBy: g }); O && !a.lang[g] && (O.split && (O = O.split(",")), 0 <= CKEDITOR.tools.indexOf(O, a.langCode) ?
                            N = a.langCode : (N = a.langCode.replace(/-.*/, ""), N = N != a.langCode && 0 <= CKEDITOR.tools.indexOf(O, N) ? N : 0 <= CKEDITOR.tools.indexOf(O, "en") ? "en" : O[0]), k.langEntries && k.langEntries[N] ? (a.lang[g] = k.langEntries[N], N = null) : f.push(CKEDITOR.getUrl(k.path + "lang/" + N + ".js"))); e.push(N); d.push(k)
    ...
    (function () {
        function a(a) { return a.attributes["data-cke-survive"] ? !1 : "a" == a.name && a.attributes.href || CKEDITOR.dtd.$removeEmpty[a.name] } var d = CKEDITOR.tools.extend({ table: 1, ul: 1, ol: 1, dl: 1 }, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), b = { ol: 1, ul: 1 }, c = CKEDITOR.tools.extend({}, { html: 1 }, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, { style: 1, script: 1 }), f = { ul: "li", ol: "li", dl: "dd", table: "tbody", tbody: "tr", thead: "tr", tfoot: "tr", tr: "td" }; CKEDITOR.htmlParser.fragment.fromHtml =
            function (e, k, h) {
                function q(a) { var b; if (0 < l.length) for (var c = 0; c < l.length; c++) { var d = l[c], e = d.name, f = CKEDITOR.dtd[e], g = w.name && CKEDITOR.dtd[w.name]; g && !g[e] || a && f && !f[a] && CKEDITOR.dtd[a] ? e == w.name && (x(w, w.parent, 1), c--) : (b || (m(), b = 1), d = d.clone(), d.parent = w, w = d, l.splice(c, 1), c--) } } function m() { for (; L.length;)x(L.shift(), w) } function g(a) {
                    ...
                    if (a(f)) l.push(f); else {
                        if ("pre" == e) G = !0; else { if ("br" == e && G) { w.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == e && (J = !0) } if ("br" == e) L.push(f); else {
                            for (; !(h = (g = w.name) ? CKEDITOR.dtd[g] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || w.isUnknown || h[e]);)if (w.isOptionalClose) F.onTagClose(g); else if (e in b && g in b) g = w.children, (g = g[g.length - 1]) && "li" == g.name || x(g = new CKEDITOR.htmlParser.element("li"), w), !f.returnPoint && (f.returnPoint = w), w = g; else if (e in CKEDITOR.dtd.$listItem &&
                                !A(e, g)) F.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (g in d && !A(e, g)) !f.returnPoint && (f.returnPoint = w), w = w.parent; else if (g in CKEDITOR.dtd.$inline && l.unshift(w), w.parent) x(w, w.parent, 1); else { f.isOrphan = 1; break } q(e); m(); f.parent = w; f.isEmpty ? x(f) : w = f
                        }
                    }
                    ...
                    if (!(w._.hasInlineStarted && !L.length || G || J) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = w.name, e = b ? CKEDITOR.dtd[b] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) :
                        c; if (!J && !e["#"] && b in d) F.onTagOpen(f[b] || ""), F.onText(a); else { m(); q(); G || J || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " ")); a = new CKEDITOR.htmlParser.text(a); if (y(w, a)) this.onTagOpen(h, {}, 0, 1); w.add(a) }
                }; F.onCDATA = function (a) { w.add(new CKEDITOR.htmlParser.cdata(a)) }; F.onComment = function (a) { m(); q(); w.add(new CKEDITOR.htmlParser.comment(a)) }; F.parse(e); for (m(); w != v;)x(w, w.parent, 1); g(v); return v
        ...
        function a() { this.rules = [] } function d(b, c, d, e) { var k, h; for (k in c) (h = b[k]) || (h = b[k] = new a), h.add(c[k], d, e) } CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            add: function (a, c, d) { this.rules.splice(this.findIndex(c), 0, { value: a, priority: c, options: d }) }, addMany: function (a,
                c, d) { for (var e = [this.findIndex(c), 0], k = 0, h = a.length; k < h; k++)e.push({ value: a[k], priority: c, options: d }); this.rules.splice.apply(this.rules, e) }, findIndex: function (a) { for (var c = this.rules, d = c.length - 1; 0 <= d && a < c[d].priority;)d--; return d + 1 }, exec: function (a, c) {
                    var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, e = Array.prototype.slice.call(arguments, 1), k = this.rules, h = k.length, q, m, g, x; for (x = 0; x < h; x++)if (d && (q = c.type, m = c.name), g = k[x], !(a.nonEditable && !g.options.applyToAll ||
                        a.nestedEditable && g.options.excludeNestedEditable)) { g = g.value.apply(null, e); if (!1 === g || d && g && (g.name != m || g.type != q)) return g; null != g && (e[0] = c = g) } return c
    ...
    (function () {
        function a(a, d) {
            ...
            } var z = { elements: {} }, h = "html" == d, B = CKEDITOR.tools.extend({}, p), E; for (E in B) "#" in J[E] || delete B[E]; for (E in B) z.elements[E] = t(h, a.config.fillEmptyBlocks); z.root = t(h, !1); z.elements.br = function (a) {
                return function (b) {
        ...
        } function k(a, b) { var c = a.children[a.children.length - 1]; a.children.push(b); b.parent = a; c && (c.next = b, b.previous = c) } function h(a) { a = a.attributes; "false" != a.contenteditable && (a["data-cke-editable"] = a.contenteditable ? "true" : 1); a.contenteditable = "false" } function q(a) { a = a.attributes; switch (a["data-cke-editable"]) { case "true": a.contenteditable = "true"; break; case "1": delete a.contenteditable } } function m(a, b) {
            return a.replace(t,
        ...
        } function g(a, b) { return a.replace(b, function (a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + A(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) } function x(a) { return a.replace(N, function (a, b) { return decodeURIComponent(b) }) } function y(a) {
            ...
            }; var L = /(?:&nbsp;|\xa0)$/, w = "{cke_protected}", J = CKEDITOR.dtd, G = "caption colgroup col thead tfoot tbody".split(" "), p = CKEDITOR.tools.extend({}, J.$blockLimit, J.$block), u = { elements: { input: h, textarea: h } }, K = {
            ...
            }; CKEDITOR.env.ie && (C.attributes.style = function (a) { return a.replace(/(^|;)([^\:]+)/g, function (a) { return a.toLowerCase() }) }); var t = /<(a|area|img|input|source)\b([^>]*)>/gi, B = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, z = /^(href|src|name)$/i, H = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, O = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi,
                N = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, r = /(<\/?)((?:object|embed|param|html|body|head|title)([\s][^>]*)?>)/gi, I = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, M = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi; l = function () {
    ...
    (function () {
        function a(a, f, e, k) {
            ...
            var b = a.name, d =
                a.element, k = a.elementMode, h = a.fire("uiSpace", { space: "top", html: "" }).html, q = a.fire("uiSpace", { space: "bottom", html: "" }).html, m = new CKEDITOR.template('\x3c{outerEl} id\x3d"cke_{name}" class\x3d"{id} cke cke_reset cke_chrome cke_editor_{name} cke_{langDir} ' + CKEDITOR.env.cssClass + '"  dir\x3d"{langDir}" lang\x3d"{langCode}" role\x3d"application"' + (a.applicationTitle ? ' aria-labelledby\x3d"cke_{name}_arialbl"' : "") + "\x3e" + (a.applicationTitle ? '\x3cspan id\x3d"cke_{name}_arialbl" class\x3d"cke_voice_label"\x3e{voiceLabel}\x3c/span\x3e' :
                    "") + '\x3c{outerEl} class\x3d"cke_inner cke_reset" role\x3d"presentation"\x3e{topHtml}\x3c{outerEl} id\x3d"{contentId}" class\x3d"cke_contents cke_reset" role\x3d"presentation"\x3e\x3c/{outerEl}\x3e{bottomHtml}\x3c/{outerEl}\x3e\x3c/{outerEl}\x3e'), b = CKEDITOR.dom.element.createFromHtml(m.output({
                        id: a.id, name: b, langDir: a.lang.dir, langCode: a.langCode, voiceLabel: a.applicationTitle, topHtml: h ? '\x3cspan id\x3d"' + a.ui.spaceId("top") + '" class\x3d"cke_top cke_reset_all" role\x3d"presentation" style\x3d"height:auto"\x3e' +
                            h + "\x3c/span\x3e" : "", contentId: a.ui.spaceId("contents"), bottomHtml: q ? '\x3cspan id\x3d"' + a.ui.spaceId("bottom") + '" class\x3d"cke_bottom cke_reset_all" role\x3d"presentation"\x3e' + q + "\x3c/span\x3e" : "", outerEl: CKEDITOR.env.ie ? "span" : "div"
                    })); k == CKEDITOR.ELEMENT_MODE_REPLACE ? (d.hide(), b.insertAfter(d)) : d.append(b); a.container = b; a.ui.contentsElement = a.ui.space("contents"); h && a.ui.space("top").unselectable(); q && a.ui.space("bottom").unselectable(); d = a.config.width; k = a.config.height; d && b.setStyle("width",
            ...
            var d = this, k = this._.modes; if (a != d.mode && k && k[a]) {
                d.fire("beforeSetMode", a); if (d.mode) {
                    var h = d.checkDirty(), k = d._.previousModeData, q, m = 0; d.fire("beforeModeUnload");
                    d.editable(0); d._.previousMode = d.mode; d._.previousModeData = q = d.getData(1); "source" == d.mode && k == q && (d.fire("lockSnapshot", { forceUpdate: !0 }), m = 1); d.ui.space("contents").setHtml(""); d.mode = ""
            ...
            var h =
                this.container, q = this.ui.space("contents"), m = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement; k = k ? this.container.getFirst(function (a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasClass("cke_inner") }) : h; if (a || 0 === a) a = CKEDITOR.tools.convertToPx(CKEDITOR.tools.cssLength(a)); k.setSize("width", a, !0); m && (m.style.width = "1%"); b = CKEDITOR.tools.convertToPx(CKEDITOR.tools.cssLength(b)); var g = (k.$.offsetHeight || 0) - (q.$.clientHeight || 0), h = Math.max(b - (d ? 0 : g), 0); b = d ? b + g : b; q.setStyle("height",
    ...
    (function () {
        ...
        function q(a, b, c) { return !1 !== a.config.autoParagraph && a.activeEnterMode != CKEDITOR.ENTER_BR && (a.editable().equals(c) && !b || b && "true" == b.getAttribute("contenteditable")) } function m(a) { return a.activeEnterMode != CKEDITOR.ENTER_BR && !1 !== a.config.autoParagraph ? a.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p" : !1 } function g(a) { a && a.isEmptyInlineRemoveable() && a.remove() } function x(a) { var b = a.editor; b.getSelection().scrollIntoView(); setTimeout(function () { b.fire("saveSnapshot") }, 0) } function y(a, b, c) {
            var d = a.getCommonAncestor(b);
            for (b = a = c ? b : a; (a = a.getParent()) && !d.equals(a) && 1 == a.getChildCount();)b = a; b.remove()
        } var A, F, v, l, L, w, J, G, p, u, K = { ul: 1, ol: 1, dl: 1 }; CKEDITOR.editable = CKEDITOR.tools.createClass({
                                    ...
                                    a.document =
                                        this.getDocument(); a.window = this.getWindow(); var g = a.document; this.changeAttr("spellcheck", !a.config.disableNativeSpellChecker); var f = a.config.contentsLangDirection; this.getDirection(1) != f && this.changeAttr("dir", f); var z = CKEDITOR.getCss(); if (z) {
                                            var f = g.getHead(), H = f.getCustomData("stylesheet"); H ? z != H.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? H.$.styleSheet.cssText = z : H.setText(z)) : (z = g.appendStyleText(z), z = new CKEDITOR.dom.element(z.ownerNode || z.owningElement), f.setCustomData("stylesheet",
                                                z), z.data("cke-temp", 1))
                                        } f = g.getCustomData("stylesheet_ref") || 0; g.setCustomData("stylesheet_ref", f + 1); this.setCustomData("cke_includeReadonly", !a.config.disableReadonlyStyling); this.attachListener(this, "click", function (a) { a = a.data; var b = (new CKEDITOR.dom.elementPath(a.getTarget(), this)).contains("a"); b && 2 != a.$.button && b.isReadOnly() && a.preventDefault() }); var O = { 8: 1, 46: 1 }; this.attachListener(a, "key", function (b) {
                                            if (a.readOnly) return !0; var c = b.data.domEvent.getKey(), d, g = a.getSelection(); if (0 !== g.getRanges().length) {
                                                if (c in
                                                    ...
                                                    var f; b = g.getRanges()[0]; var t = b.startPath(), z, B, H, c = 8 == c, m = !1; if (CKEDITOR.env.ie && 11 > CKEDITOR.env.version && g.getSelectedElement()) f = g.getSelectedElement(); else if (e(g)) {
                                                        var l = new CKEDITOR.dom.walker(b), q = b.collapsed ? b.startContainer : l.next(), m = !1, C; if (b.checkStartOfBlock()) { C = b.startPath().block || b.startPath().blockLimit; var p = C.getName(); C = -1 !== CKEDITOR.tools.array.indexOf(["dd", "dt", "li"], p) && null === C.getPrevious() } else C = !1; if (C) {
                                                            for (; q && !m;)m = q.$.nodeName.toLowerCase(), m = !!K[m], q = l.next();
                                                            l = h(b.startPath()); q = h(b.endPath()); m = m || l !== q
                                        ...
                                        }); a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller && this.attachListener(this, "keyup", function (b) { b.data.getKeystroke() in O && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select()) }); this.attachListener(this, "dblclick", function (b) { if (a.readOnly) return !1; b = { element: b.data.getTarget() }; a.fire("doubleclick", b) }); CKEDITOR.env.ie && this.attachListener(this,
                                            "click", b); CKEDITOR.env.ie && !CKEDITOR.env.edge || this.attachListener(this, "mousedown", function (b) { var c = b.data.getTarget(); c.is("img", "hr", "input", "textarea", "select") && !c.isReadOnly() && (a.getSelection().selectElement(c), c.is("input", "textarea", "select") && b.data.preventDefault()) }); CKEDITOR.env.edge && this.attachListener(this, "mouseup", function (b) { (b = b.data.getTarget()) && b.is("img") && !b.isReadOnly() && a.getSelection().selectElement(b) }); CKEDITOR.env.gecko && this.attachListener(this, "mouseup", function (b) {
                                                ...
                                                if (a.readOnly) return !0; var c =
                                                    b.data.domEvent.getKey(); if (c in O && (b = a.getSelection(), 0 !== b.getRanges().length)) {
            ...
            function () {
                function a(b) { return b.type == CKEDITOR.NODE_ELEMENT } function b(c, d) {
                    var e, g, f, r, h = [], t = d.range.startContainer; e = d.range.startPath(); for (var t = l[t.getName()], k = 0, z = c.getChildren(), B = z.count(), H = -1, I = -1, M = 0, m = e.contains(l.$list); k < B; ++k)e = z.getItem(k), a(e) ? (f = e.getName(), m && f in CKEDITOR.dtd.$list ? h = h.concat(b(e, d)) : (r = !!t[f], "br" != f || !e.data("cke-eol") || k && k != B - 1 || (M = (g = k ? h[k - 1].node : z.getItem(k + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && l.$block[g.getName()]), -1 != H || r || (H = k), r || (I = k), h.push({
                        isElement: 1,
                        isLineBreak: M, isBlock: e.isBlockBoundary(), hasBlockSibling: g, node: e, name: f, allowed: r
                    }), g = M = 0)) : h.push({ isElement: 0, node: e, allowed: 1 }); -1 < H && (h[H].firstNotAllowed = 1); -1 < I && (h[I].lastNotAllowed = 1); return h
                } function d(b, c) { var e = [], g = b.getChildren(), f = g.count(), h, r = 0, k = l[c], z = !b.is(l.$inline) || b.is("br"); for (z && e.push(" "); r < f; r++)h = g.getItem(r), a(h) && !h.is(k) ? e = e.concat(d(h, c)) : e.push(h); z && e.push(" "); return e } function e(b) { return a(b.startContainer) && b.startContainer.getChild(b.startOffset - 1) } function f(b) {
                    return b &&
                ...
                } var l = CKEDITOR.dtd, r = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1 }, I = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1 }, M = CKEDITOR.tools.extend({}, l.$inline); delete M.br; return function (r, D, R, p) {
                    var x = r.editor, v = !1, y; "unfiltered_html" == D && (D = "html", v = !0); if (!p.checkReadOnly()) {
                        var A = (new CKEDITOR.dom.elementPath(p.startContainer, p.root)).blockLimit ||
                            p.root; D = { type: D, dontFilter: v, editable: r, editor: x, range: p, blockLimit: A, mergeCandidates: [], zombies: [] }; var v = D.range, A = D.mergeCandidates, u = "html" === D.type, w, T, F, W, K; "text" == D.type && v.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (T = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", v.document), v.insertNode(T), v.setStartAfter(T)); F = new CKEDITOR.dom.elementPath(v.startContainer); D.endPath = W = new CKEDITOR.dom.elementPath(v.endContainer); if (!v.collapsed) {
                                ...
                                f(w) && A.push(w); for (w = T.startNode; (w = w.getParent()) && f(w);)A.push(w); v.moveToBookmark(T); y = r.getHtml(); y = "" === y || y.match(L); x.enterMode === CKEDITOR.ENTER_DIV && y && ((x = r.getFirst()) && x.remove(), p.setStartAt(r, CKEDITOR.POSITION_AFTER_START), p.collapse(!0)); if (r = R) {
                                    r = D.range; if ("text" == D.type && D.inlineStylesRoot) { p = D.inlineStylesPeak; x = p.getDocument().createText("{cke-peak}"); for (y = D.inlineStylesRoot.getParent(); !p.equals(y);)x = x.appendTo(p.clone()), p = p.getParent(); R = x.getOuterHtml().split("{cke-peak}").join(R) } p =
                                        D.blockLimit.getName(); if (/^\s+|\s+$/.test(R) && "span" in CKEDITOR.dtd[p]) { var J = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e'; R = J + R + J } R = D.editor.dataProcessor.toHtml(R, { context: null, fixForBody: !1, protectedWhitespaces: !!J, dontFilter: D.dontFilter, filter: D.editor.activeFilter, enterMode: D.editor.activeEnterMode }); p = r.document.createElement("body"); p.setHtml(R); J && (p.getFirst().remove(), p.getLast().remove()); if ((J = r.startPath().block) && (1 != J.getChildCount() || !J.getBogus())) a: {
                                            var Q; if (1 ==
                                                p.getChildCount() && a(Q = p.getFirst()) && Q.is(I) && !Q.hasAttribute("contenteditable")) { J = Q.getElementsByTag("*"); r = 0; for (y = J.count(); r < y; r++)if (x = J.getItem(r), !x.is(M)) break a; Q.moveChildren(Q.getParent(1)); Q.remove() }
                                        } D.dataWrapper = p; r = R
                                } if (r) {
                                    Q = D.range; r = Q.document; p = D.blockLimit; y = 0; var G, J = [], ca, P; R = T = 0; var U, x = Q.startContainer; K = D.endPath.elements[0]; var S, v = K.getPosition(x), A = !!K.getCommonAncestor(x) && v != CKEDITOR.POSITION_IDENTICAL && !(v & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED),
                                        x = b(D.dataWrapper, D); for (D.editor.enterMode !== CKEDITOR.ENTER_BR && k(x, Q); y < x.length; y++) {
                                            v = x[y]; if (u = v.isLineBreak) u = Q, w = p, W = F = void 0, v.hasBlockSibling ? u = 1 : (F = u.startContainer.getAscendant(l.$block, 1)) && F.is({ div: 1, p: 1 }) ? (W = F.getPosition(w), W == CKEDITOR.POSITION_IDENTICAL || W == CKEDITOR.POSITION_CONTAINS ? u = 0 : (w = u.splitElement(F), u.moveToPosition(w, CKEDITOR.POSITION_AFTER_START), u = 1)) : u = 0; if (u) R = 0 < y; else {
                                                u = Q.startPath(); !v.isBlock && q(D.editor, u.block, u.blockLimit) && (P = m(D.editor)) && (P = r.createElement(P),
                                                    P.appendBogus(), Q.insertNode(P), CKEDITOR.env.needsBrFiller && (G = P.getBogus()) && G.remove(), Q.moveToPosition(P, CKEDITOR.POSITION_BEFORE_END)); if ((u = Q.startPath().block) && !u.equals(ca)) { if (G = u.getBogus()) G.remove(), J.push(u); ca = u } v.firstNotAllowed && (T = 1); if (T && v.isElement) {
                                                        u = Q.startContainer; for (w = null; u && !l[u.getName()][v.name];) { if (u.equals(p)) { u = null; break } w = u; u = u.getParent() } if (u) w && (U = Q.splitElement(w), D.zombies.push(U), D.zombies.push(w)); else {
                                                            w = p.getName(); S = !y; u = y == x.length - 1; w = d(v.node, w); F = [];
                ...
                function a(b, c) { var d = b.getParent(); if (d.is(CKEDITOR.dtd.$inline)) b[c ? "insertBefore" : "insertAfter"](d) } function b(c, d, e) {
                    ...
                    fixUneditableRangePosition: function (a) { a.startContainer.getDtd()["#"] || a.moveToClosestEditablePosition(null, !0) }, autoParagraph: function (a, b) { var c = b.startPath(), d; q(a, c.block, c.blockLimit) && (d = m(a)) && (d = b.document.createElement(d), d.appendBogus(), b.insertNode(d), b.moveToPosition(d, CKEDITOR.POSITION_AFTER_START)) }
                }
            }()
    })();
    (function () {
        function a(a) { return CKEDITOR.plugins.widget && CKEDITOR.plugins.widget.isDomWidget(a) } function d(b, c) {
        ...
        } function k() { u = !0; p || (h.call(this), p = CKEDITOR.tools.setTimeout(h, 200, this)) } function h() { p = null; u && (CKEDITOR.tools.setTimeout(e, 0, this), u = !1) } function q(a) { return K(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? !0 : !1 } function m(a) {
            function b(c, d) { return c && c.type != CKEDITOR.NODE_TEXT ? a.clone()["moveToElementEdit" + (d ? "End" : "Start")](c) : !1 } if (!(a.root instanceof CKEDITOR.editable)) return !1; var c = a.startContainer, d = a.getPreviousNode(q,
                null, c), e = a.getNextNode(q, null, c); return b(d) || b(e, 1) || !(d || e || c.type == CKEDITOR.NODE_ELEMENT && c.isBlockBoundary() && c.getBogus()) ? !0 : !1
            ...
            "function" != typeof window.getSelection, L = 1, w = CKEDITOR.tools.repeat("​", 7), J = new RegExp(w + "( )?", "g"), G, p, u, K = CKEDITOR.dom.walker.invisible(1), E = function () {
                ...
                function b() { var a = c.getSelection(); a && a.removeAllRanges() } var c = a.editor; c.on("contentDom", function () {
                    ...
                    }, null, null, -1); n.attachListener(n, "mousedown", function () { q = 0 }); if (CKEDITOR.env.ie || CKEDITOR.env.gecko || B) l ? n.attachListener(n, "beforedeactivate", a, null, null, -1) : n.attachListener(c, "selectionCheck", a, null, null, -1), n.attachListener(n, CKEDITOR.env.webkit || CKEDITOR.env.gecko ?
                        "focusout" : "blur", function () { var a = p && (p.isFake || 2 > p.getRanges().length); CKEDITOR.env.gecko && !B && a || (c.lockSelection(p), q = 1) }, null, null, -1), n.attachListener(n, "mousedown", function () { q = 0 }); if (CKEDITOR.env.ie && !B) {
                    ...
                    getNative: function () { return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel : this._.cache.nativeSel = l ? this.document.$.selection : this.document.getWindow().$.getSelection() }, getType: l ? function () {
                        ...
                        var a = l ? function () {
                            function a(b) { return (new CKEDITOR.dom.node(b)).getIndex() } var b = function (b, c) {
                                b = b.duplicate(); b.collapse(c); var d = b.parentElement(); if (!d.hasChildNodes()) return { container: d, offset: 0 }; for (var e = d.children, g, f, h = b.duplicate(), k = 0, m = e.length - 1, t = -1, l, q; k <= m;)if (t = Math.floor((k + m) / 2), g = e[t], h.moveToElementText(g), l = h.compareEndPoints("StartToStart",
                                    b), 0 < l) m = t - 1; else if (0 > l) k = t + 1; else return { container: d, offset: a(g) }; if (-1 == t || t == e.length - 1 && 0 > l) { h.moveToElementText(d); h.setEndPoint("StartToStart", b); h = h.text.replace(/(\r\n|\r)/g, "\n").length; e = d.childNodes; if (!h) return g = e[e.length - 1], g.nodeType != CKEDITOR.NODE_TEXT ? { container: d, offset: e.length } : { container: g, offset: g.nodeValue.length }; for (d = e.length; 0 < h && 0 < d;)f = e[--d], f.nodeType == CKEDITOR.NODE_TEXT && (q = f, h -= f.nodeValue.length); return { container: q, offset: -h } } h.collapse(0 < l ? !0 : !1); h.setEndPoint(0 <
                                        l ? "StartToStart" : "EndToStart", b); h = h.text.replace(/(\r\n|\r)/g, "\n").length; if (!h) return { container: d, offset: a(g) + (0 < l ? 0 : 1) }; for (; 0 < h;)try { f = g[0 < l ? "previousSibling" : "nextSibling"], f.nodeType == CKEDITOR.NODE_TEXT && (h -= f.nodeValue.length, q = f), g = f } catch (p) { return { container: d, offset: a(g) } } return { container: q, offset: 0 < l ? -h : q.nodeValue.length + h }
                            }; return function () {
                        ...
                        if (c) for (var c = this.root, e, h = 0; h < a.length; ++h)e = a[h], e.endContainer.equals(c) && (e.endOffset = Math.min(e.endOffset, c.getChildCount())); if (a.length) if (this.isLocked) { var k = CKEDITOR.document.getActive(); this.unlock(); this.selectRanges(a); this.lock(); k && !k.equals(this.root) && k.focus() } else {
                            var r; a: {
                                var q, M; if (1 == a.length && !(M = a[0]).collapsed && (r = M.getEnclosedNode()) && r.type == CKEDITOR.NODE_ELEMENT && (M = M.clone(), M.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (q = M.getEnclosedNode()) && q.type == CKEDITOR.NODE_ELEMENT &&
                                    (r = q), "false" == r.getAttribute("contenteditable"))) break a; r = void 0
                                ...
                                if (l) {
                                    q = CKEDITOR.dom.walker.whitespaces(!0); r = /\ufeff|\u00a0/; M = { table: 1, tbody: 1, tr: 1 }; 1 < a.length && (b = a[a.length - 1], a[0].setEnd(b.endContainer, b.endOffset)); b = a[0]; a = b.collapsed; var n, D, p; if ((c = b.getEnclosedNode()) &&
                                        c.type == CKEDITOR.NODE_ELEMENT && c.getName() in C && (!c.is("a") || !c.getText())) try { p = c.$.createControlRange(); p.addElement(c.$); p.select(); return } catch (v) { } if (b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.getName() in M || b.endContainer.type == CKEDITOR.NODE_ELEMENT && b.endContainer.getName() in M) b.shrink(CKEDITOR.NODE_ELEMENT, !0), a = b.collapsed; p = b.createBookmark(); M = p.startNode; a || (k = p.endNode); p = b.document.$.body.createTextRange(); p.moveToElementText(M.$); p.moveStart("character", 1); k ? (r =
                                            b.document.$.body.createTextRange(), r.moveToElementText(k.$), p.setEndPoint("EndToEnd", r), p.moveEnd("character", -1)) : (n = M.getNext(q), D = M.hasAscendant("pre"), n = !(n && n.getText && n.getText().match(r)) && (D || !M.hasPrevious() || M.getPrevious().is && M.getPrevious().is("br")), D = b.document.createElement("span"), D.setHtml("\x26#65279;"), D.insertBefore(M), n && b.document.createText("﻿").insertBefore(M)); b.setStartBefore(M); M.remove(); a ? (n ? (p.moveStart("character", -1), p.select(), b.document.$.selection.clear()) : p.select(),
                                                b.moveToPosition(D, CKEDITOR.POSITION_BEFORE_START), D.remove()) : (b.setEndBefore(k), k.remove(), p.select())
                                } else {
                                    k = this.getNative(); if (!k) return; this.removeAllRanges(); for (p = 0; p < a.length; p++) {
                                        if (p < a.length - 1 && (n = a[p], D = a[p + 1], r = n.clone(), r.setStart(n.endContainer, n.endOffset), r.setEnd(D.startContainer, D.startOffset), !r.collapsed && (r.shrink(CKEDITOR.NODE_ELEMENT, !0), b = r.getCommonAncestor(), r = r.getEnclosedNode(), b.isReadOnly() || r && r.isReadOnly()))) {
                                            D.setStart(n.startContainer, n.startOffset); a.splice(p--,
                                                1); continue
                                        } b = a[p]; D = this.document.$.createRange(); b.collapsed && CKEDITOR.env.webkit && m(b) && (r = g(this.root), b.insertNode(r), (n = r.getNext()) && !r.getPrevious() && n.type == CKEDITOR.NODE_ELEMENT && "br" == n.getName() ? (x(this.root), b.moveToPosition(n, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(r, CKEDITOR.POSITION_AFTER_END)); D.setStart(b.startContainer.$, b.startOffset); try { D.setEnd(b.endContainer.$, b.endOffset) } catch (u) {
    ...
    (function () {
        function a(a, b) { for (var c, d; (a = a.getParent()) && !a.equals(b);)if (a.getAttribute("data-nostyle")) c = a; else if (!d) { var e = a.getAttribute("contentEditable"); "false" == e ? c = a : "true" == e && (d = 1) } return c } function d(a, b, c, d) { return (a.getPosition(b) | d) == d && (!c.childRule || c.childRule(a)) } function b(c) {
            var e = c.document; if (c.collapsed) e = L(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
                var g = this.element, h = this._.definition, k, m = h.ignoreReadonly, l = m || h.includeReadonly; null ==
                    l && (l = c.root.getCustomData("cke_includeReadonly")); var q = CKEDITOR.dtd[g]; q || (k = !0, q = CKEDITOR.dtd.span); c.enlarge(CKEDITOR.ENLARGE_INLINE, 1); c.trim(); var p = c.createBookmark(), t = p.startNode, v = p.endNode, x = t, u; if (!m) { var y = c.getCommonAncestor(), m = a(t, y), y = a(v, y); m && (x = m.getNextSourceNode(!0)); y && (v = y) } for (x.getPosition(v) == CKEDITOR.POSITION_FOLLOWING && (x = 0); x;) {
            ...
            function b() {
                for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(l.getParent()), e = null, g = null, f = 0; f < a.elements.length; f++) { var h = a.elements[f]; if (h == a.block || h == a.blockLimit) break; q.checkElementRemovable(h, !0) && (e = h) } for (f = 0; f < c.elements.length; f++) {
                ...
                var l = c.endNode, q = this; b(); for (g = d; !g.equals(l);)f = g.getNextSourceNode(), g.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(g) && (g.getName() == this.element ? A.call(this, g) : v(g, G(this)[g.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) &&
                    (b(), f = d.getNext())), g = f
        ...
        } function h(a) { var b = a.createBookmark(!0), c = a.createIterator(); c.enforceRealBlocks = !0; this._.enterMode && (c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR); for (var d, e = a.document, g; d = c.getNextParagraph();)!d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (g = L(this, e, d), m(d, g)); a.moveToBookmark(b) } function q(a) {
            ...
            b, c) { if (b = b && b.attributes) for (var d = 0; d < b.length; d++) { var e = b[d][0], g; if (g = a.getAttribute(e)) { var f = b[d][1]; (null === f || f.test && f.test(g) || "string" == typeof f && g == f) && a.removeAttribute(e) } } c || l(a) } function l(a, b) {
                ...
                apply: function (a) { if (a instanceof CKEDITOR.dom.document) return K.call(this, a.getSelection()); if (this.checkApplicable(a.elementPath(), a)) { var b = this._.enterMode; b || (this._.enterMode = a.activeEnterMode); K.call(this, a.getSelection(), 0, a); this._.enterMode = b } }, remove: function (a) {
                    ...
                    this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ?
                        q : this.type == CKEDITOR.STYLE_OBJECT ? k : null; return this.removeFromRange(a)
    ...
    (function () {
        var a = {}, d = {}, b; for (b in CKEDITOR.dtd.$blockLimit) b in CKEDITOR.dtd.$list || (a[b] = 1); for (b in CKEDITOR.dtd.$block) b in CKEDITOR.dtd.$blockLimit || b in CKEDITOR.dtd.$empty || (d[b] = 1); CKEDITOR.dom.elementPath = function (b, f) {
            var e = null, k = null, h = [], q = b, m; f = f || b.getDocument().getBody(); q || (q = f); do if (q.type == CKEDITOR.NODE_ELEMENT) {
                h.push(q); if (!this.lastElement && (this.lastElement = q, q.is(CKEDITOR.dtd.$object) || "false" == q.getAttribute("contenteditable"))) continue; if (q.equals(f)) break; if (!k && (m = q.getName(),
                    "true" == q.getAttribute("contenteditable") ? k = q : !e && d[m] && (e = q), a[m])) { if (m = !e && "div" == m) { a: { m = q.getChildren(); for (var g = 0, x = m.count(); g < x; g++) { var y = m.getItem(g); if (y.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[y.getName()]) { m = !0; break a } } m = !1 } m = !m } m ? e = q : k = q }
            } while (q = q.getParent()); k || (k = f); this.block = e; this.blockLimit = k; this.root = f; this.elements = h
        }
    })();
                ...
                var a = this, c = CKEDITOR.dom.walker.bookmark(), d = [], e; return {
                    getNextRange: function (k) {
                        e = void 0 === e ? 0 : e + 1; var h = a[e]; if (h && 1 < a.length) {
                            if (!e) for (var q = a.length - 1; 0 <= q; q--)d.unshift(a[q].createBookmark(!0)); if (k) for (var m = 0; a[e + m + 1];) {
                                var g = h.document; k = 0; q = g.getById(d[m].endNode); for (g = g.getById(d[m + 1].startNode); ;) {
                                    q =
                                        q.getNextSourceNode(!1); if (g.equals(q)) k = 1; else if (c(q) || q.type == CKEDITOR.NODE_ELEMENT && q.isBlockBoundary()) continue; break
                                } if (!k) break; m++
                            } for (h.moveToBookmark(d.shift()); m--;)q = a[++e], q.moveToBookmark(d.shift()), h.setEnd(q.endContainer, q.endOffset)
                        } return h
                    }
                }
            ...
            getUiColor: function () { return this.uiColor }, setUiColor: function (a) {
                var b = c(CKEDITOR.document); return (this.setUiColor = function (a) {
                    this.uiColor = a; var c = CKEDITOR.skin.chameleon, d = "", e = ""; "function" == typeof c && (d = c(this, "editor"), e =
                        c(this, "panel")); a = [[q, a]]; f([b], d, a); f(h, e, a)
                }).call(this, a)
            }
        }); var k = "cke_ui_color", h = [], q = /\$color/g; CKEDITOR.on("instanceLoaded", function (a) {
...
*/
    ...
    (function () {
        ...
        init: function (c) {
            var e = 0, d = function (g, d, b, a) { if (a) { a = new CKEDITOR.style(a); var f = h[b]; f.unshift(a); c.attachStyleStateChange(a, function (a) { !c.readOnly && c.getCommand(b).setState(a) }); c.addCommand(b, new CKEDITOR.styleCommand(a, { contentForms: f })); c.ui.addButton && c.ui.addButton(g, { isToggle: !0, label: d, command: b, toolbar: "basicstyles," + (e += 10) }) } }, h = {
                ...
                '\x3e\x26nbsp;\x3c/span\x3e\x3cspan id\x3d"{id}_label" class\x3d"cke_button_label cke_button__{name}_label" aria-hidden\x3d"false"\x3e{label}\x3c/span\x3e\x3cspan id\x3d"{id}_description" class\x3d"cke_button_label" aria-hidden\x3d"false"\x3e{ariaShortcutSpace}{ariaShortcut}\x3c/span\x3e{arrowHtml}\x3c/a\x3e', v = CKEDITOR.addTemplate("buttonArrow", '\x3cspan class\x3d"cke_button_arrow"\x3e' + (CKEDITOR.env.hc ? "\x26#9660;" : "") + "\x3c/span\x3e"), w = CKEDITOR.addTemplate("button", c); CKEDITOR.plugins.add("button",
                    { beforeInit: function (a) { a.ui.addHandler(CKEDITOR.UI_BUTTON, CKEDITOR.ui.button.handler) } }); CKEDITOR.UI_BUTTON = "button"; CKEDITOR.ui.button = function (a) { CKEDITOR.tools.extend(this, a, { isToggle: a.isToggle || !1, title: a.label, click: a.click || function (b) { b.execCommand(a.command) } }); this._ = {} }; CKEDITOR.ui.button.handler = { create: function (a) { return new CKEDITOR.ui.button(a) } }; CKEDITOR.ui.button.prototype = {
                        render: function (a, b) {
                            ...
                            return b ? (b.setState(a, "cke_button"), b.setAttribute("aria-disabled", a == CKEDITOR.TRISTATE_DISABLED), this.isToggle && !this.hasArrow ? b.setAttribute("aria-pressed", a === CKEDITOR.TRISTATE_ON) : this.hasArrow && b.setAttribute("aria-expanded", a == CKEDITOR.TRISTATE_ON), !0) : !1
        ...
        } var z = function () { this.toolbars = [] }; z.prototype.focus = function () { for (var a = 0, d; d = this.toolbars[a++];)for (var f = 0, c; c = d.items[f++];)if (c.focus) { c.focus(); return } }; var E = { modes: { wysiwyg: 1, source: 1 }, readOnly: 1, exec: function (a) { a.toolbox && (CKEDITOR.env.ie || CKEDITOR.env.air ? setTimeout(function () { a.toolbox.focus() }, 100) : a.toolbox.focus()) } }; CKEDITOR.plugins.add("toolbar",
            {
                requires: "button", init: function (a) {
                    var d, f = function (c, h) {
                        ...
                        if (c.data.space == a.config.toolbarLocation) {
                            c.removeListener(); a.toolbox = new z; var d = CKEDITOR.tools.getNextId(),
                                b = ['\x3cspan id\x3d"', d, '" class\x3d"cke_voice_label"\x3e', a.lang.toolbar.toolbars, "\x3c/span\x3e", '\x3cspan id\x3d"' + a.ui.spaceId("toolbox") + '" class\x3d"cke_toolbox" role\x3d"group" aria-labelledby\x3d"', d, '" onmousedown\x3d"return false;"\x3e'], d = !1 !== a.config.toolbarStartupExpanded, e, k; a.config.toolbarCanCollapse && a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE && b.push('\x3cspan class\x3d"cke_toolbox_main"' + (d ? "\x3e" : ' style\x3d"display:none"\x3e')); for (var q = a.toolbox.toolbars, n = D(a), g = n.length,
                                    l = 0; l < g; l++) {
                                var r, m = 0, w, p = n[l], v = "/" !== p && ("/" === n[l + 1] || l == g - 1), x; if (p) if (e && (b.push("\x3c/span\x3e"), k = e = 0), "/" === p) b.push('\x3cspan class\x3d"cke_toolbar_break"\x3e\x3c/span\x3e'); else {
                                    x = p.items || p; for (var y = 0; y < x.length; y++) {
                                        var t = x[y], A; if (t) {
                                            var B = function (c) { c = c.render(a, b); u = m.items.push(c) - 1; 0 < u && (c.previous = m.items[u - 1], c.previous.next = c); c.toolbar = m; c.onkey = f }; if (t.type == CKEDITOR.UI_SEPARATOR) k = e && t; else {
                                                A = !1 !== t.canGroup; if (!m) {
                                                    r = CKEDITOR.tools.getNextId(); m = { id: r, items: [] }; w = p.name &&
                                                        (a.lang.toolbar.toolbarGroups[p.name] || p.name); b.push('\x3cspan id\x3d"', r, '" class\x3d"cke_toolbar' + (v ? ' cke_toolbar_last"' : '"'), w ? ' aria-labelledby\x3d"' + r + '_label"' : "", ' role\x3d"toolbar"\x3e'); w && b.push('\x3cspan id\x3d"', r, '_label" class\x3d"cke_voice_label"\x3e', w, "\x3c/span\x3e"); b.push('\x3cspan class\x3d"cke_toolbar_start"\x3e\x3c/span\x3e'); var u = q.push(m) - 1; 0 < u && (m.previous = q[u - 1], m.previous.next = m)
                                                } A ? e || (b.push('\x3cspan class\x3d"cke_toolgroup" role\x3d"presentation"\x3e'), e = 1) : e && (b.push("\x3c/span\x3e"),
                                                    e = 0); k && (B(k), k = 0); B(t)
                                            }
                                        }
                ...
                var c = v(this.editor), h = 0 === d, b = { name: a }; if (f) {
                    if (f = CKEDITOR.tools.search(c, function (a) { return a.name == f })) {
                        !f.groups && (f.groups = []); if (d && (d = CKEDITOR.tools.indexOf(f.groups, d), 0 <= d)) { f.groups.splice(d + 1, 0, a); return } h ? f.groups.splice(0, 0, a) : f.groups.push(a);
                        return
                    } d = null
