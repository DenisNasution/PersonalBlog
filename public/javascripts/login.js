...
(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = "function" == typeof require && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = "MODULE_NOT_FOUND", a } var p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = "function" == typeof require && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
    1: [function (require, module, exports) {
        ...
        const token = "nama=Denis; lastName=jaja "
        ...
        if (formLogin) {
            formLogin.addEventListener('submit', async (e) => {
                ...
                // document.cookie = "test=" + user
                // localStorage.setItem('test', JSON.stringify({ "id": 1, "name": 'denis' }));
                // const test = JSON.parse(localStorage.getItem('test'))
                // console.log(document.cookie);
                // document.cookie = "auth_sign = eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE2NjEwNDgxNTAsImV4cCI6MTY2Mjc3NjE1MH0.WvJfsWDo0soiJK5ziG9QHhZomCcSc3NgA7T2c6T6opM;max-age=0"
                // document.cookies.remove()
                await Axios.post('http://localhost:2500/signin', { user, pass })
                    .then(response => {
                        document.cookie = "auth_sign=" + response.data.token
                        localStorage.setItem('persona_data', JSON.stringify({ "id": response.data._id, "username": response.data.user }));
        ...
        //         location.href = "http://localhost:3000/coba/edit"
        //         await Axios.get(`http://localhost:3000/coba/getData/${id}`)
        //             .then(async (response) => {
        //                 tampilPesan()
        //             })
        //     })
