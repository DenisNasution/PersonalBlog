...
blogForm.addEventListener('submit', async (e) => {
    e.preventDefault();
    // console.log("judul: ", blogForm['judul'].value, "description:", blogForm['description'].value);
    // const dataInput = { judul: blogForm['judul'].value, description: blogForm['description'].value }
    // socket.emit("dataInput", dataInput)
